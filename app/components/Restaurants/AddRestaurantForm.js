...
function Map(props) {
  ...
  const confirmLocation = () => {
    ...
    toastRef.current.show("Guardado con exito");
    ...
    (async () => {
      ...
      if (statusPermissions !== "granted") {
        toastRef.current.show(
          "Tienes que aceptar los permisos e localización para crear un restaurante",
          3000
        );
      } else {
...
function UploadImage(props) {
  ...
  const imageSelect = async () => {
    ...
    if (resultPermissions === "denied") {
      toastRef.current.show(
        "Es necesario aceptar los permisos de lo contrario tienes que ir a ajustes y activarlos manualmente.",
        3000
      );
    } else {
